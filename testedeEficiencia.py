...
for i in range(len(enderecoForm)):
    #enderecoForm,blurKernel,divideScale,threshAny,threshMax,kernelAnchor1,kernelAnchor2,dilateIterations,enderecoResultado
    resultados = aplicarOCRcomIMG(enderecoForm[i],5,5,0,1,3,13,1,enderecoResultado[i])
